<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="row">
        <div class="col-12 col-sm-12">
            <form action="<?php echo base_url('web/adicionarweb') ?>" method="POST">
                <div class="row">
                    <div class="col-6">
                        <label for="nomeWeb" class="form-label">Nome Cliente:</label>
                        <input type="text" class="form-control" name="nomeWeb" id="nomeWeb">
                    </div>
                    <div class="col-6">
                    ...
                    <div class="col-6 mt-4">
                        ...
                        <input type="text" class="form-control" name="loginWeb" id="loginWeb">
                    </div>
                    <div class="col-6 mt-4">
                        <label for="senhaWeb" class="form-label">Senha:</label>
                        <input type="text" class="form-control" name="senhaWeb" id="senhaWeb">
                    </div>
                    <div class="col-12 mt-4">
                        <div class="mb-3">
                            <label for="infoAdicionalWeb" class="form-label">Informações Adicionais</label>
                            <textarea class="form-control summernote" id="infoAdicionalWeb" name="infoAdicionalWeb" rows="3"></textarea>
                        </div>
                    </div>
                    <div class="col-12">
